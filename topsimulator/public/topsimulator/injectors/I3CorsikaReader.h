...
public:
    ...
    /**
       As the method name states: This is a hack to shift al particle's z-coordinate upwards a fixed amount.
       This is usually called immediately after I3CorsikaReader::NextRun() (before reading in any particles!)
    */
    ...
    double GetObsLevel() const
    { return zObsLevel_ + I3Constants::OriginElev; }
