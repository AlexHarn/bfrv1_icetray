...
class I3TankResponse
{
 public:
   ...
   * This is method is called by the injector service (the minimum should be the actual tank height).
   */
   ...
   * This is method is called by the injector service (the minimum should be the actual tank radius)
   */
   ...
   * It should return True if the particle has hit a tank (it generated a signal).
   */
