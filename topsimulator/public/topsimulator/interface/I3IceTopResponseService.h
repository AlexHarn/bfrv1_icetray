...
/**
 * \brief Each IceTop tank has a corresponding I3TankResponse object. This service provides access to them.
 *
 * CORSIKA files can be very large and iterating over all particles for each tanks can be
 * very costly. A solution adopted in topsimulator is to index tank according to positions.
 * This class provides the methods for indexing and fast access to tank responses.
 *
 */
