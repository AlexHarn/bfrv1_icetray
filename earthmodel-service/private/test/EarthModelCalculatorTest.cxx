...
TEST(Integration_test){
   ...
   // note that sin is an overloaded function in c++11, so we must specify which one
   ENSURE_DISTANCE(Integration::rombergIntegrate((double(*)(double))(&sin),0,M_PI,1e-6),2,1e-6);
   mSin mySin;
