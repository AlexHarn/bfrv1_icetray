...
parser.add_argument("--SeparateMCTreeName", type=str, default="", dest="separate_mctree_name",
...
SeparateMCTreeName = args.separate_mctree_name
...
tray.AddModule("Rename","rename_mctree", Keys=['I3MCTree','SignalI3MCTree'])
...
def CombineSignal(frame):
    ...
    signal_tree = frame['SignalI3MCTree']
    combined_tree = frame['BackgroundI3MCTree']
    polyplopia.MergeMCTrees(combined_tree, signal_tree,0)
    frame["I3MCTree"] = combined_tree
    del frame['BackgroundI3MCTree']
