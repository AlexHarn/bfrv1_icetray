...
def PPCTraySegment(tray,
                   ...
                   holeice_parametrization=expandvars("$I3_SRC/ice-models/resources/models/angsens/as.h2-50cm"),
                   IceModel="Spice3.2.1",
        ...
        os.putenv("PPCHOLEICE", holeice_parametrization)
        ...
        tray.AddModule("i3ppc", "ppc", 
                  ...
                  #gpu=GPU, 
                  efficiency_scaling_factor = efficiency,
                  cyl=volumecyl,
        ...
        def add_empty_pes(f,mcpeseries="MCPESeriesMap"):
                  if mcpeseries not in f:
                     f[mcpeseries] = I3MCPESeriesMap()
        tray.Add(add_empty_pes,mcpeseries="MCPESeriesMap",streams=[icetray.I3Frame.DAQ])
...
class PPC(ipmodule.ParsingModule):
   ...
   def Configure(self,tray):
        ...
        tray.AddSegment(PPCTraySegment,"ppc_photons",
			...
			holeice_parametrization=self.holeiceparametrization,
