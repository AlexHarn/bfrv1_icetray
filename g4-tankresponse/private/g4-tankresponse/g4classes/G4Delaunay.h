 ...
 *
 * The snow volume is created using the BuildSolid method, which takes a non-const pointer to a G4TessellatedSolid.
 * Prior to doing this, one has to add all the points that define a Delaunay triangulation of the surface.
 * Each of the tiles in the tessellated solid correspond to a triangle in the triangulation.
 *
 */
class G4Delaunay
{
