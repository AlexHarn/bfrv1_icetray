...
TEST(HitSorting_Convertions){
  ...
  */
  ...
  RetrievalOrderedHitSet hits_retrieval = ExtractHits(recoMap);
  ...
  RetrievalOrderedHitSet hits_first = ExtractHits(recoMap, Extract_FirstHitOnly);
  ...
  RetrievalOrderedHitSet hits_csummed = ExtractHits(recoMap, Extract_TotalChargeToFirstHit);
  ...
  I3RecoPulseSeriesMap recoMap_csummed = ConvertHits2RecoPulseSeriesMap( hits_csummed );
