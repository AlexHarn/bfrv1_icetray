...
# recclasses and simclasses aren't guaranteed to exist,
# so if the import fails we just move on.
try:
    from icecube import recclasses
except ImportError:
    icetray.logging.log_debug("Failed to import recclasses")
    
try:
    from icecube import simclasses
except ImportError:
    icetray.logging.log_debug("Failed to import simclasses")
