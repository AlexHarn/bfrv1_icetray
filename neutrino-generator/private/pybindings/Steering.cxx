...
void register_Steering()
{
  bp::class_<nugen::Steering, boost::shared_ptr<nugen::Steering>, boost::noncopyable >
     ...
     #define PROPS (NGen) (SimMode) (VTXGenMode) (InjectionMode) (DetectionSurface) (CylinderParams) (NSteps) (StepSize)
     ...
     .def("set_global_xsec_scale_vec", &nugen::Steering::SetGlobalXsecScalesVec, "set cross section scale parameter for CC, NC, GR interactions. ex. [1.0, 1.0, 0.0]")
