...
void register_TypeDefs()
{
  ...
  def("to_simulation_mode", &ToSimMode,"string to simulation mode conversion");
  def("to_vtxgen_mode", &ToVTXGenMode,"string to vtxgen mode conversion");
  def("to_injection_mode", &ToInjectionMode,"string to injection mode conversion");
  def("to_propagation_mode", &ToPropagationMode,"string to propagation mode conversion");
  def("to_angle_sampling_mode", &ToAngleSamplingMode,"string to angle sampling mode conversion");
