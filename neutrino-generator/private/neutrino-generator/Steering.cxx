   ...
   ignoreOutgoingAngleForNC_(Defaults::ignoreOutgoingAngleForNC)
{
   ...
   AddParameter("SimMode", 
                "Select one from Full, InEarth, Detector",
                 simModeString_);
   ...
   AddParameter("MuonRangeOpt", "Do Not touch the value unless"
                                ...
                                "See descriptions of SetMuonRangeOpt()",
                                 muRangeOpt_);
   AddParameter("NSteps", "number of default steps for propagation in Earth",
                               nsteps_);
      ...
      if (cylinderParams_[0] > 0 && cylinderParams_[1] > 0) {
         ...
         detectionSurface_ = 
            I3Surfaces::SamplingSurfacePtr(new I3Surfaces::Cylinder(
                                        cylinderParams_[1],  //length
                                        cylinderParams_[0],  //radius
                                        I3Position(cylinderParams_[2],  //origin x
                                                   cylinderParams_[3],  //origin y
                                                   cylinderParams_[4]))); // origin z
      } else {
...
void Steering::PrintSetting() 
{
   ...
   log_info("CylinderParams[0]    %f", cylinderParams_[0]);
   log_info("CylinderParams[1]    %f", cylinderParams_[1]);
   log_info("CylinderParams[2]    %f", cylinderParams_[2]);
   log_info("CylinderParams[3]    %f", cylinderParams_[3]);
   log_info("CylinderParams[4]    %f", cylinderParams_[4]);
   log_info("MuRangeExtension     %d", doMuRangeExtension_);
   log_info("MuRangeOpt           %f", muRangeOpt_);
   log_info("NSteps               %d", nsteps_);
