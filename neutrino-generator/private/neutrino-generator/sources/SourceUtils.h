...
namespace SourceUtils{
  ...
  void FillDiffusePrimaryGenInfo(boost::shared_ptr<Particle> nu,
                                 boost::shared_ptr<Steering> steer,
                                     double gannmaIndex,
                                     double energyMinLog,
                                     double energyMaxLog,
  ...
  void FillPointPrimaryGenInfo(boost::shared_ptr<Particle> nu,
                               boost::shared_ptr<Steering> steer,
                               double gammaIndex,
                               double energyMinLog,
                               double energyMaxLog,
  ...
  void FillInjectionGeomInfo(boost::shared_ptr<Steering> steer, 
