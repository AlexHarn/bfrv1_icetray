 ...
 *
 *  @brief   EnumTypeDef IMPLEMENTATION FILE
 */
...
std::string GetSimModeString(SimMode t)
{
     ...
     else if ( t == DETECTOR ) type_string="Detector";
     return type_string;
}
...
std::string GetAngleSamplingModeString(AngleSamplingMode t)
{
     ...
     else if ( t == ANGEMU )  type_string="AngEmu";
     return type_string;
}
...
SimMode ToSimMode(const std::string &ss)
{
     ...
     else if ( s == "FINALONLY")  t = DETECTOR;
     else if ( s == "DETECTOR")  t = DETECTOR;
     else {
