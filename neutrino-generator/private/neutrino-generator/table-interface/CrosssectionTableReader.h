...
class CrosssectionTableReader {
   ...
   static const int SizeEnergyBin =  1000;//Default CTEQ5 file use 121
 ...
 public:
   ...
   inline double GetMinEnergy() { return std::pow(10, Xmin); }
   inline double GetMaxEnergy() { return std::pow(10, Xmax); }
