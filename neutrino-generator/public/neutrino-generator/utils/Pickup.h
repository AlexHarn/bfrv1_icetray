...
class Pickup {
   ...
   * Interface function
   */
  std::pair<bool, std::pair<boost::shared_ptr<Particle>, double> >
   ...
   * particle, as pair<bool, pair<ParticlePtr, weight> >. 
   * if the pickup failed, the first bool will be false and returned values are dummy.
   * Check the bool value before using the result.
   */
  std::pair<bool, std::pair<boost::shared_ptr<Particle>, double> >
