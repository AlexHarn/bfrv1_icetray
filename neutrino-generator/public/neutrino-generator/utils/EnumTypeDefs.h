...
namespace nugen {
   ...
   * DETECTOR - simulate final interaction only, formally called FINALONLY
   */
  enum SimMode    {FULL=0, INEARTH=1, DETECTOR=2};
   ...
   *        (don't use it for physics analysis)
   * ANGEMU -- emulating ANG mode with allowing weight
   *           back to COS mode 
   */
  enum AngleSamplingMode {COS=0, ANG=1, ANGEMU=2};
