...
class I3NuGInteractionInfo : public I3ServiceBase {
 ...
 public:
   ...
   * Set energy minimum and maximum that gives physical
   * results. 
   */
  void SetMinEnergy(double d) {energyMin_ = d;}
  void SetMaxEnergy(double d) {energyMax_ = d;}
  double GetMinEnergy() { return energyMin_;}
  double GetMaxEnergy() { return energyMax_;}
