...
def I3CLSimMakePhotons(tray, name,
    ...
    :param ParticleHistory:
        Record particles produced inside Geant. At the moment this simply prints
        the muons, taus, and their decay products via log_info().
...
def I3CLSimMakePhotonsWithServer(tray, name,
    ...
    if DetectorSettings['UseGeant4']:
        ...
        if ParticleHistory:
            icetray.logging.set_level_for_unit('I3CLSimLightSourcePropagatorGeant4', 'INFO')
