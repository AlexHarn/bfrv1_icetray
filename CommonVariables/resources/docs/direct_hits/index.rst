...
.. note::
   there used to be a global variable called `default_definitions`, this
   was removed in favor of :py:func:`get_default_definitions` because of
   unexpected behavior. If you have this in your script, please switch.
