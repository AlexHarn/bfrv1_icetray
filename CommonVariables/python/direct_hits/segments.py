...
def I3DirectHitsCalculatorSegment(tray, name,
    ...
    **i3module_kwargs
    ...
    if BookIt:
        if(not 'OutputI3DirectHitsValuesBaseName' in i3module_kwargs.keys()):
            raise ValueError(
        ...
        if(not 'DirectHitsDefinitionSeries' in i3module_kwargs.keys()):
            raise ValueError(
        ...
        tray.AddSegment(I3DirectHitsValuesBookerSegment, name,
            DirectHitsDefinitionSeries       = i3module_kwargs['DirectHitsDefinitionSeries'],
            OutputI3DirectHitsValuesBaseName = i3module_kwargs['OutputI3DirectHitsValuesBaseName']
        )
        return tableio_keys
