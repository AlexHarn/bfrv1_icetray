...
static int projgr_(integer *, doublereal *, doublereal *,
    integer *, doublereal *, doublereal *, doublereal *, doublereal *);

static int mainlb_(integer *n, integer *m, doublereal *x, 
...
static int active_(integer *n, doublereal *l, doublereal *u, 
    integer *nbd, doublereal *x, integer *iwhere, integer *iprint, 
    logical *prjctd, logical *cnstnd, logical *boxed);

static int bmv_(integer *m, doublereal *sy, doublereal *wt, integer 
    *col, doublereal *v, doublereal *p, integer *info);

static int cauchy_(integer *n, doublereal *x, doublereal *l, 
...
static int cmprlb_(integer *n, integer *m, doublereal *x, 
...
static int errclb_(integer *n, integer *m, doublereal *factr, 
    doublereal *l, doublereal *u, integer *nbd, char *task, integer *info,
    integer *k, ftnlen task_len);

static int formk_(integer *n, integer *nsub, integer *ind, integer *
...
static int formt_(integer *m, doublereal *wt, doublereal *sy, 
    doublereal *ss, integer *col, doublereal *theta, integer *info);

static int freev_(integer *n, integer *nfree, integer *index, 
    integer *nenter, integer *ileave, integer *indx2, integer *iwhere, 
    logical *wrk, logical *updatd, logical *cnstnd, integer *iprint, 
    integer *iter);

static int hpsolb_(integer *n, doublereal *t, integer *iorder, 
    integer *iheap);

static int lnsrlb_(integer *n, doublereal *l, doublereal *u, 
...
static int matupd_(integer *n, integer *m, doublereal *ws, 
...
static int prn1lb_(integer *n, integer *m, doublereal *l, 
    doublereal *u, doublereal *x, integer *iprint, integer *itfile, 
    doublereal *epsmch);

static int prn2lb_(integer *n, doublereal *x, doublereal *f, 
...
static int prn3lb_(integer *n, doublereal *x, doublereal *f, char *
...
static int subsm_(integer *n, integer *m, integer *nsub, integer *
...
static int dcsrch_(doublereal *f, doublereal *g, doublereal *stp, 
...
/*     scale is a DOUBLE PRECISION array of length n.  This must be set */
/*       by the user to contain the scale sizes for the components of */
/*       the gradient, and is used when computing the gradient */
/*       termination test. */
...
/*                 max{|proj g_i/scale_i | i = 1, ..., n} <= pgtol */

/*         where pg_i is the ith component of the projected gradient */
/*         and scale_i is the ith component of the user supplied scale */
/*         vector. */
...
/*     iprint is an integer variable. It is unused. */
	...
	integer *head, integer *info)
{
    ...
    /* Subroutine */ int dpofa_(doublereal *, integer *, integer *, 
