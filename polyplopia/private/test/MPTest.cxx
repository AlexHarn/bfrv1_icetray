...
TEST(MergeTrees)
{
  ...
  for (unsigned int i=0; i< treesize; i++)
  {
          ...
          PolyplopiaUtils::MergeMCTrees(*mctree, *newMCTree, t);
  }
...
TEST(MergePEs)
{
   ...
   MergeMCPEs(newMCPESeriesMap,mcPESeriesMap1,offsetTime,I3ParticleIDMapPtr(),I3ParticleIDMapPtr());
   offsetTime = 10000.*rand()*I3Units::ns/RAND_MAX;
   MergeMCPEs(newMCPESeriesMap,mcPESeriesMap2,offsetTime,I3ParticleIDMapPtr(),I3ParticleIDMapPtr());
