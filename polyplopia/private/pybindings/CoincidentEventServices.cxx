...
#include <polyplopia/MuonGunBackgroundService.h>
...
{
  register_coincidenteventservice<CoincidentI3ReaderService>("CoincidentI3ReaderService", "corsika reader for coincident bg", init<std::string>())
