  ...
  weightMap_("CorsikaWeightMap")
{
  ...
  AddParameter("Rate", "Event rate (zero if polyplopia should get this from summary service)", 0.0);
...
void I3PolyplopiaExp::Merge(I3FramePtr frame)
{
    ...
    while (coinc_frames_.size() > 0) 
    {
      ...
      PolyplopiaUtils::MergeFrames(frame, cframe, names_, offsetTime);
      ...
      // Put the CorsikaWeight for this primary into the frame
