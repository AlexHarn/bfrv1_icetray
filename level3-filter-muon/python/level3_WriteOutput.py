...
def WriteOutput(tray, name, Suffix, output_i3, output_hd5, output_root):
    ...
    mc_keeps_booking.remove("I3MCTree_preMuonProp")
    ...
    # Jul.5 hoshina: TimeWindowDefinition E is NOT already in DirectHitsDefs 
    ...
    def GetPrimary(frame):
        if ((frame.Has("I3MCTree") or frame.Has("I3MCTree_preMuonProp")) and not frame.Has("MCPrimary1")):
            if frame.Has("I3MCTree_preMuonProp") :
                # I3MCTree will be deleted in future, use I3MCTree_preMuonProp if exists.
    ...
    tray.AddModule(GetPrimary, Streams=[icetray.I3Frame.DAQ])

    def GetMostEnergeticTrack(frame):
        if (frame.Has("I3MCTree") or frame.Has("I3MCTree_preMuonProp")) :
            if frame.Has("I3MCTree_preMuonProp"):
                # I3MCTree will be removed in future, use I3MCTree_preMuonProp if exists.
                mctree = frame["I3MCTree_preMuonProp"]
            else :
                mctree = frame["I3MCTree"]
    ...
    def replaceMCTree(frame):
        if frame.Has("I3MCTree"):
            tree=frame["I3MCTree"]
            if isinstance(tree, dataclasses.I3LinearizedMCTree) :
                # I3MCTree is I3LinearizedMCTree. nothing to do. 
                return True
            del frame["I3MCTree"]
