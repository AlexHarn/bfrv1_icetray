...
I3Position I3GENIE_Helper::extractPosition(const I3GENIEResultDictConstPtr& resultDict, const I3Position& positionShift){
    I3Position pos(GetFromVariantMap<double>("vtxx", *resultDict)*I3Units::m,
...
bool I3GENIE_Helper::ConvertToMCTree(I3MCTreePtr mcTree,  I3MapStringDoublePtr weightDict, I3GENIEResultDictConstPtr resultDict, const I3Position& positionShift)
{
    // add the primary
    I3Particle primary;
    {
        ...
        primary.SetPos(extractPosition(resultDict, positionShift));
    ...
    // add leptonic secondary
    {
        ...
        secondary.SetPos(extractPosition(resultDict, positionShift));
