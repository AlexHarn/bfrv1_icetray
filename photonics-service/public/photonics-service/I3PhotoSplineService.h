...
class I3PhotoSplineService : public I3PhotonicsService, public I3ServiceBase {
    ...
    void GetKnotVector(double *knots, int dimension);
    void GetNumKnots(long &num_knots, int dimension);
    void GetAxisOrder(int &order, int dimension);
    void GetTimeSliceCoefficients(double *results, int time_dimension, int derivative, int area_norm);
