...
from icecube.photonics_service import I3PhotonicsServiceCollection, I3MapOMTypeI3PhotonicsService
try:
...
# DeepCore DOMs  = pDOMs?
amplitudetable_pdom = TablePath+'/LowEnergyCorrectedCascades_z20_a10_250m.abs.fits'
timingtable_pdom = TablePath+'LowEnergyCorrectedCascades_z20_a10_250m.prob.fits'
...
cservice_dict = {I3OMGeo.OMType.IceCube: photonics_service.I3PhotoSplineService(amplitudetable, timingtable, 0),
                 I3OMGeo.OMType.PDOM: photonics_service.I3PhotoSplineService(amplitudetable_pdom, timingtable_pdom, 0)
             }

cascade_service = I3PhotonicsServiceCollection(I3MapOMTypeI3PhotonicsService(cservice_dict))
