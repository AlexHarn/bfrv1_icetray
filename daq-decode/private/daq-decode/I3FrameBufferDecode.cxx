...
I3FrameBufferDecode::I3FrameBufferDecode(const I3Context& context) 
  : I3ConditionalModule(context),
    ...
    decoderService_(I3DefaultName<I3DAQEventDecoder>::value())
{
  ...
  AddParameter("ExceptionID",
               ...
               exceptionID_);
  AddParameter("DecoderServiceName",
	       "Name of installed service to provide event decoding",
	       decoderService_);
...
void I3FrameBufferDecode::Configure()
{
  ...
  GetParameter("DecoderServiceName", decoderService_);
  if(!(decoder_ = context_.Get<I3DAQEventDecoderPtr>(decoderService_)))
    log_fatal("context contains nothing at slot \"%s\"", decoderService_.c_str());
}
