...
I3MonopoleRelativisticUtils::PropagateFastMonopole(
  ...
  for (auto const &input_tree_iter : *input_tree) {
    ...
    initial_monopole_iter->SetLength(
            CalculateNextLength(stepSize_, initial_monopole_iter->GetEnergy(), mp_mass, maxlength_, minlength_));
...
I3MonopoleRelativisticUtils::AddMonopole(I3Particle mp,
  ...
  double const lengthNext = CalculateNextLength(stepSize, energyNext, mpMass, maxlength, minlength);
