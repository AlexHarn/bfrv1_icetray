...
namespace I3MonopoleGeneratorUtils {
    ...
    *@return beta
    ...
    /**
    *@brief Sanity checks for the mass parameter (1e5 GeV < mass < 1e17 GeV, mass needed for relativistic monopoles.)
    *@param mass
    */
    ...
    *@param min minimal value returned
    *@param max maximal value returned
    *@param powerlaw powerlaw to be weighted by, only positive values are supported but interepreted as negativ
    */
