...
#include "monopole-propagator/I3MonopoleSlowUtils.h"
...
namespace mp_sec_io_test
{
  ...
  public:
    ...
    void DAQ(I3FramePtr frame){
      ...
      for(tree_iter=testTree.begin(); tree_iter!=testTree.end(); tree_iter++){
  ...
  public :
	...
	if(tree_iter->GetType()!=I3Particle::Monopole){
      ...
      ENSURE_DISTANCE(tree_iter->GetEnergy(),expEnergy_,1e-8);  // If mfp is too low, ENSURE_EQUAL fails due to rounding error
	}
      }
      PushFrame(frame,"OutBox");
    }
