...
def calculate_weight(MPInfoDict_WeightFilewideNormalized, monogen_DiskRadius_in_meter):
    ...
    return 4 * math.pi ** 2 * 10000 * monogen_DiskRadius_in_meter**2 * MPInfoDict_WeightFilewideNormalized
