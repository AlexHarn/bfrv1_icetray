...
void register_I3DOM()
{
  ...
  bp::class_<I3DOM, boost::shared_ptr<I3DOM>, boost::noncopyable>("I3DOM", bp::no_init)
    ...
    .add_property("merge_pulses",&I3DOM::GetMergePulses,
                         &I3DOM::SetMergePulses)
    .add_property("use_tabulation",&I3DOM::SetUseTabulation,
                         &I3DOM::GetUseTabulation)
    .add_property("use_drooped_template",&I3DOM::SetUseDroopedTemplate,
