...
datadir = "/data/sim/IceCube/2006/generated/dataset_68/"

runTag = "nugen_nue.000068.000071.i3.gz"
...
if 1 :
	tray.AddModule("I3CLastModule","CLast")(
                ("Name"       , "CLast"         )
	        ("RecoSeries" , "FE-Hit-Series" )
  )

if 1 :
	tray.AddModule("I3Panalysis", "panalysis")(
		("RootFilename","CLast_timing.root"),
    		("MCName", "MCList" ),
    		("AsciiFilename", "CLast_timing.txt" ),
      		("RecoName", "CLast" ),
		("ParticleType", "EMinus:EPlus:Hadrons:TauPlus") )
