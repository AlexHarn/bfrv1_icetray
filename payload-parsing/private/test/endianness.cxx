...
TEST(decode_uint16_t_enoughdtata)
{
  ...
  data[8] = 0x12;
  data[9] = 0x34;
  EXPECT_THROW(decode<uint16_t>(LITTLE,9,data), "That should have thrown.");
}
...
{ 
  ...
  EXPECT_THROW(decode<uint32_t>(LITTLE,7,data), "That should have thrown");
}
...
{ 
  ...
  EXPECT_THROW(decode<uint64_t>(LITTLE,23,data), "That should have thrown");
}
...
TEST(decode_uint16_t_enoughdtata_BIG)
{
  ...
  data[8] = 0x12;
  data[9] = 0x34;
  EXPECT_THROW(decode<uint16_t>(BIG,9,data), "That should have thrown");
}
...
{ 
  ...
  EXPECT_THROW(decode<uint32_t>(BIG,7,data), "That should have thrown");
}
...
{ 
  ...
  EXPECT_THROW(decode<uint64_t>(BIG,23,data), "That should have thrown");
}
