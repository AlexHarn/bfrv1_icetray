...
I3PayloadParsingEventDecoderFactory::I3PayloadParsingEventDecoderFactory(
  ...
  iceTopID_("IceTop"), 
  speDataID_("RawData"),
  mbServiceID_(I3DefaultName<I3OMKey2MBID>::value()),
  installServiceAs_(I3DefaultName<I3DAQEventDecoder>::value())
{
  AddParameter("Year",
  ...
  AddParameter("MinBiasID",
      ...
      "Trigger mode",
      minBiasID_);
  AddParameter("MainBoardServiceName",
      "Name of installed service to provide mainBoardID to OMKey decoding",
      mbServiceID_);
...
{	
  if(!decoder_){
    I3OMKey2MBID& omkey2mbid = context_.Get<I3OMKey2MBID>(mbServiceID_);
  ...
  return services.Put(installServiceAs_, decoder_);
}
...
void I3PayloadParsingEventDecoderFactory::Configure()
{
  ...
  GetParameter("MainBoardServiceName", mbServiceID_);
