...
"""
UNITTEST for ReducingLikelihoodTester: Create a artificial series of testframes and check if the processing goes through
"""
...
class TestDaqSequence(unittest.TestCase):
  ...
  def __init__(self, methodName='runTest'):
    super(TestDaqSequence,self).__init__(methodName)
  ...
  def testSequence(self):
    ...
    if (self.frame.Stop == icetray.I3Frame.DAQ):
      ...
      self.assert_(ra[0] == "MutualReducingLikelihoodTester")
      self.assert_(ra[1] == "HypoReducingLikelihoodTester")
      self.assert_(ra[2] == "MutualReducingLikelihoodREFITTester")
      self.assert_(ra[3] == "HypoReducingLikelihoodREFITTester")
...
class TestPhysicsSequence(unittest.TestCase):
  ...
  def __init__(self, methodName='runTest'):
    ...
    self.pframes = 0
    self.modules = ["HypoReducingLikelihoodREFITTester",
                    "HypoReducingLikelihoodTester",
                    "MutualReducingLikelihoodREFITTester",
                    "MutualReducingLikelihoodTester"]
  def testSequence(self):
    if (self.frame.Stop == icetray.I3Frame.Physics): #just to be sure
      if (self.pframes == 0):
        ...
        self.assert_(rs.keys().sort()==self.modules.sort())
        for module in self.modules:
          self.assert_(rs[module]==True)
      else:
...
tray.AddModule("ReducingLikelihoodTester", "MutualReducingLikelihoodTester",
  SplitName = SplitName,
  HypoName = "hypoframe",
  HypoFitName = "HFit",
  RecoFitName = "Fit",
...
tray.AddModule("ReducingLikelihoodTester", "HypoReducingLikelihoodTester",
  SplitName = SplitName,
  HypoName = "hypoframe",
  HypoFitName = "HFit",
  RecoFitName = "Fit",
...
tray.AddModule("ReducingLikelihoodTester", "MutualReducingLikelihoodREFITTester",
  SplitName = SplitName,
  HypoName = "hypoframe",
  HypoFitName = "HFit",
  RecoFitName = "Fit",
...
tray.AddModule("ReducingLikelihoodTester", "HypoReducingLikelihoodREFITTester",
  SplitName = SplitName,
  HypoName = "hypoframe",
  HypoFitName = "HFit",
  RecoFitName = "Fit",
